...
@Component({
  selector: 'app-vote-question-nopic-multiple',
  templateUrl: './vote-question-nopic-multiple.component.html',
  styleUrls: ['./vote-question-nopic-multiple.component.css']
})
export class VoteQuestionNopicMultipleComponent implements OnInit {
